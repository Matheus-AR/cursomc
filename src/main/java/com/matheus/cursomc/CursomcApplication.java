...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gamil.com", "37283283723", TipoCliente.PESSOAFISICA);
		
		cli1.getTelefones().addAll(Arrays.asList("1235432132", "1294238753"));
		
		Endereco e1 = new Endereco(null, "Rua flores", "300", "Apto 303", "Jardim", "12345678", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 108", "Centro", "23464590", cli1, c1);
